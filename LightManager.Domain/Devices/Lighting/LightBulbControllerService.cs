...
using LightManager.Core.Services.Manager;
...
public class LightBulbCommandBuilder
{
	...
	public LightBulbCommandBuilder SetColorTemperature(LightSourceColorTemperature temperature, CancellationToken token = default)
	{
		cmd.Add("color_temp", temperature.Value.ToString());
		return this;
	}

	public LightBulbCommandBuilder SetIntensity(LightSourceIntensity intensity, CancellationToken token = default)
	{
